...
public class CategoryListAddActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.category_list_add_activity);
        ...
        ArrayList<Category> arrayOfItems = new ArrayList<Category>();
        adapter = new CategoryCustomAdapter(this, arrayOfItems);
    ...
    public void editdeletedialog(){
        android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.
                Builder(CategoryListAddActivity.this);
        LayoutInflater inflater = getLayoutInflater();
        View convertView = (View) inflater.inflate(R.layout.edit_delete_listview, null);
        alertDialog.setView(convertView);

        ArrayAdapter<String> arrayAdapter=new ArrayAdapter<String>(CategoryListAddActivity.this,
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position,
                ...
                switch(option) {
                    ...
                    case "Change Icon":
                        ...
                        break;
                    case "Remove Icon":
                        Utils.removeSelectedIcon(CategoryListAddActivity.this,t_category.getText().toString());
                        finish();
                        overridePendingTransition( 0, 0);
                        startActivity(getIntent());
                        overridePendingTransition( 0, 0);
                        Toast.makeText(CategoryListAddActivity.this, "Icon Removed", Toast.LENGTH_SHORT).show();
                        break;
                }
    ...
    public void change_icon(){
        ...
        CustomGridViewActivity adapterViewAndroid = new CustomGridViewActivity(CategoryListAddActivity.this,icons);
        ...
        androidGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Utils.storeSelectedIcon(CategoryListAddActivity.this,img_str,t_category.getText().toString());
                finish();
                overridePendingTransition( 0, 0);
                startActivity(getIntent());
                overridePendingTransition( 0, 0);
    ...
    public void editDialogeset(){
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(CategoryListAddActivity.this);
        alertDialog.setTitle("CATEGORY");
        alertDialog.setMessage("Edit Category");

        input1 = new EditText(CategoryListAddActivity.this);
        ...
        alertDialog.setPositiveButton("YES",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        if(input1.length()==0){
                            Toast.makeText(CategoryListAddActivity.this, "Please Enter Your Category", Toast.LENGTH_SHORT).show();
                        }
                        else{
                            update_database();
                        }
    ...
    public void fetchData(CategoryCustomAdapter adapter){
        Cursor cursor;
        cursor = databaseHelper.getCategoryData(databaseHelper.CATEGORY_TABLE);
        if (cursor != null && cursor.moveToFirst()) {
            do {
                Category cartItem = new Category(category,id);
            ...
            Toast.makeText(CategoryListAddActivity.this, "No Data found", Toast.LENGTH_SHORT).show();
        }
    }
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.category_add_bar_menu,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_category_add) {
            ...
            input = new EditText(CategoryListAddActivity.this);
            LinearLayout.LayoutParams lp = new LinearLayout.LayoutParams(
                    LinearLayout.LayoutParams.MATCH_PARENT,
                    LinearLayout.LayoutParams.MATCH_PARENT);
    ...
    protected void removeItemFromList(final int position) {
        ...
        alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (!adapter.isEmpty()) {
                    final ProgressDialog progressdialog = new ProgressDialog(CategoryListAddActivity.this);
                    progressdialog.setMessage("Please wait..");
                    progressdialog.show();
                    databaseHelper.deleteCategorylist(t_category.getText().toString());
                    new android.os.Handler().postDelayed(new Runnable() {
                        public void run() {
                            Toast.makeText(CategoryListAddActivity.this, "data deleted successfully", Toast.LENGTH_SHORT).show();
                            finish();
                            overridePendingTransition( 0, 0);
                            startActivity(getIntent());
                            overridePendingTransition( 0, 0);
    ...
    public void insert_database(){
        boolean inserted = databaseHelper.insertCategorylist(input.getText().toString());
        if(inserted) {
            final ProgressDialog progressdialog = new ProgressDialog(CategoryListAddActivity.this);
            progressdialog.setMessage("Please wait..");
            progressdialog.show();
            ...
            new android.os.Handler().postDelayed(new Runnable() {
                public void run() {
                    Toast.makeText(CategoryListAddActivity.this,"Data Saved", Toast.LENGTH_LONG).show();
                    finish();
                    overridePendingTransition( 0, 0);
                    startActivity(getIntent());
                    overridePendingTransition( 0, 0);
        ...
        {
            Toast.makeText(CategoryListAddActivity.this,"Data not Saved", Toast.LENGTH_LONG).show();
        }
    }
    public void update_database(){
        boolean inserted = databaseHelper.updateCategorylist(input1.getText().toString(),t_id.getText().toString());
        if(inserted)
        {final ProgressDialog progressdialog = new ProgressDialog(CategoryListAddActivity.this);
            progressdialog.setMessage("Please wait..");
            progressdialog.show();
